...
class Car:
    ...
    def __init__(self):
        ...
        self.position = [467, 617]  # Starting Position
        self.angle = 0
        self.speed = 0
    ...
    def update(self, game_map):
        ...
        self.position[0] = min(self.position[0], WIDTH - 32)
        ...
        self.position[1] = min(self.position[1], WIDTH - 32)
...
def run_simulation(genomes, config):
    ...
    while True:
        ...
        text_rect = text.get_rect()
        text_rect.center = (350, 20)  # + 40 for positioning
        screen.blit(text, text_rect)
